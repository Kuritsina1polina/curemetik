...
import com.example.curemetik.databinding.ActivityCuremetikBinding;

public class Curemetik extends AppCompatActivity {

    private ActivityCuremetikBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityCuremetikBinding.inflate(getLayoutInflater());
